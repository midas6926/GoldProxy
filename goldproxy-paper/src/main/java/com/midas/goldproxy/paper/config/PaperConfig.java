package com.midas.goldproxy.paper.config;
...
public class PaperConfig {
    ...
    public static PaperConfig loadDefault() {
        try (InputStream in = PaperConfig.class.getResourceAsStream("/config.yml")) {
            if (in == null) return new PaperConfig();
            Yaml yaml = new Yaml();
